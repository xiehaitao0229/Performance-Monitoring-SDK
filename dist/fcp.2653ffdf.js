...
exports.getHC = getHC;
},{}],"../src/helpers/getNetworkInformation.ts":[function(require,module,exports) {
"use strict";
...
var initPerformanceObserver = function initPerformanceObserver() {
  console.log('⏰ 性能收集开始', Math.random()); //收集页面全部资源性能数据
...
},{"../config":"../src/config/index.ts","./firstInput":"../src/performance/firstInput.ts","./observeInstances":"../src/performance/observeInstances.ts","./paint":"../src/performance/paint.ts","./performanceObserver":"../src/performance/performanceObserver.ts","./resourceTiming":"../src/performance/resourceTiming.ts"}],"../src/tools/isSupported.ts":[function(require,module,exports) {
"use strict";
...
var ErrorTrace = /*#__PURE__*/function () {
  ...
  _createClass(ErrorTrace, [{
    ...
    value: function globalError() {
      ...
      _constants.W.onerror = function (eventOrMessage, source, lineno, colno, error) {
        console.log('[ 我知道错误了 ]', eventOrMessage); //通过错误信息还原sourcemap源文件地址
...
var Yideng = function Yideng() {
  ...
  _config.config.maxTime = options.maxMeasureTime || _config.config.maxTime; //自动开启错误跟踪
...
var yideng = new _yideng.default({
  ...
  analyticsTracker: function analyticsTracker(options) {// console.log(Math.random());
    // console.log('-------');
    // const {
    //   metricName,
    //   eventProperties,
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","fcp/index.ts"], null)
//# sourceMappingURL=/fcp.2653ffdf.js.map